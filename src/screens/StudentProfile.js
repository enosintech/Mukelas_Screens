...
const StudentProfile = () => {
  ...
  return (
    <View className='relative w-full h-full flex items-center'>
      ...
      <View className="relative w-full h-[35%] bg-gray-600 flex items-center justify-end">
        ...
        <TouchableOpacity className="absolute w-[40px] right-3 top-14 h-[40px] shadow border-[0.5px] border-gray-300 rounded-xl bg-white flex items-center justify-center">
      ...
      <View className="w-full h-[50%] px-4">
            ...
            <TouchableOpacity className="w-full h-1/5 flex flex-row items-center justify-between px-4">
                <View className="flex flex-row items-center gap-1">
                    ...
                    <Text className="font-semibold text-[15px]">Chat Settings</Text>
                </View>
                <View>
                    <TouchableOpacity>
                        <Ionicons name="chevron-forward" size={20} color="gray"/>
            ...
            <TouchableOpacity className="w-full h-1/5 flex flex-row items-center justify-between px-4">
                <View className="flex flex-row items-center gap-1">
                    <MaterialIcons name="storage" size={25}/>
                    <Text className="font-semibold text-[15px]">Data and Storage</Text>
                </View>
                <View>
                    <TouchableOpacity>
                        <Ionicons name="chevron-forward" size={20} color="gray"/>
